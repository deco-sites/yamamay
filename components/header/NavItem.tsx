  ...
  return (
    <li class="group/navitem flex items-center w-full max-w-[160px] hover:bg-black">
      ...
      {children && children.length > 0 &&
        (
          <div
            class={`absolute flex group-hover:z-10 bg-base-100 z-50 items-start justify-center gap-6 border-t border-b-2 border-base-200 w-screen translate-x-[-50%] ${open ? 'visible': "invisible"} group-hover/navitem:visible`} 
